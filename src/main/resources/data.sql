...
INSERT INTO `category` (`category_id`, `category_name`, `category_content`, `display_order`, `created_at`, `updated_at`, `is_active`)
VALUES (1, 'Shoes', 'All types of shoes', 1, NOW(), NOW(), 1);
